...
router.post('/add', async (ctx) => {
  ...
  const student = new Students({
    ...
    ComprehensiveInnovationPractice: [{
        courseName: "思想政治实践活动",
        courseValue: IdeologicalPolitical ? IdeologicalPolitical : 0,
        IdeologicalPolitical: IdeologicalPolitical ? IdeologicalPolitical : 0,
        creditHour: 2,
        GPA: 0,
      },
      {
        courseName: "读书活动",
        courseValue: ReadingActivities ? ReadingActivities : 0,
        ReadingActivities: ReadingActivities ? ReadingActivities : 0,
        creditHour: 1,
        GPA: 0,
      },
      {
        courseName: "创新创业实践",
        courseValue: InnovationEntrepreneurship ? InnovationEntrepreneurship : 0,
        InnovationEntrepreneurship: designOfElectronic ? InnovationEntrepreneurship : 0,
        creditHour: 2,
        GPA: 0,
      },
    ],
